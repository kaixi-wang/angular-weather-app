...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container-fluid no-gutters\">\n  <!--  <div class=\"ml-auto\">-->\n    <!--    <div class=\"container-fluid\" [@pageAnimation]=\"exp\">-->\n  <!--    <div class=\"container-fluid\">-->\n      <app-weather-search #FORM></app-weather-search>\n      <ng-container *ngIf=\"FORM.submitted && FORM.showErrors\">\n        <div class=\"alert alert-warning\" role=\"alert\"><p>Invalid Address.</p></div>\n      </ng-container>\n  <div *ngIf=\"FORM.submitted && !FORM.showErrors\" id=\"wrapper-progress-bar\">\n    <mat-progress-bar id=\"mat-progress-bar\" #loadingBar\n                      [ngClass]=\"['loader-progress-bar']\"\n                      [ngStyle]=\"{'position': 'absolute', 'top.pct':'50', 'display':loadingBar.value>0 ? 'block' : 'none', 'border': loadingBar.value==0? 'none' : '1px'}\"\n                      (animationEnd)=\"loadingComplete()\" mode=\"determinate\"\n                      [value]=\"loadingBarService.progress$|async\">\n    </mat-progress-bar>\n  </div>\n\n    </div>\n    <ngb-tabset justify=\"center\">\n      <ngb-tab id=\"results-tab\" title=\"Results\" [disabled]=\"useSaved? false : !FORM.submitted\">\n        <!--        <ngb-tab id=\"results-tab\" title=\"Results\" >-->\n\n        <ng-template ngbTabContent>\n          <!--          <ng-container *ngIf=\"FORM.submitted && !FORM.showErrors\" id=\"wrapper-progress-bar\">-->\n          <!--            <mat-progress-bar id=\"mat-progress-bar\" #loadingBar-->\n          <!--                              [ngClass]=\"['loader-progress-bar', 'progress-bar-striped']\"-->\n          <!--                              [ngStyle]=\"{'position': 'absolute', 'top.pct':'50', 'display':loadingBar.value>0 ? 'block' : 'none', 'border': loadingBar.value==0? 'none' : '1px'}\"-->\n          <!--                              (animationEnd)=\"loadingComplete()\" mode=\"determinate\"-->\n          <!--                              [value]=\"loader.progress$|async\"></mat-progress-bar>-->\n          <!--          </ng-container>-->\n\n          <ng-container *ngIf=\"(FORM.submitted && (!FORM.validForm.lat || !FORM.validForm.lon))\">\n            <div class=\"alert alert-warning\" role=\"alert\"> Invalid Address.</div>\n          </ng-container>\n\n          <app-results-page @insertRemoveTrigger *ngIf=\"(FORM.submitted && !FORM.showErrors) || useSaved\"\n                            [locationData]=\"FORM.validForm\" [storedData]=\"useSaved? autoFill: null\"\n                            #RESULTS></app-results-page>\n\n        </ng-template>\n      </ngb-tab>\n\n\n      <ngb-tab id=\"favorites-tab\" title=\"Favorites\">\n        <ng-template ngbTabContent>\n          <!--            <router-outlet name=\"favorites\"></router-outlet>-->\n          <app-favorites-page (storedDataEmitter)=\"useStoredLocation($event)\"></app-favorites-page>\n        </ng-template>\n      </ngb-tab>\n    </ngb-tabset>\n\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!--<div class=\"form-group row\">-->\n<!--  <label for=\"inputCity\" class=\"col-sm-2 offset-2 col-form-label\">City-->\n<!--    <p class=\"is-invalid\">*</p>-->\n<!--    &lt;!&ndash;        <p *ngIf=\"(!inputStreet.checkValidity() && !autoInput.checked)\" class=\"is-invalid\">*</p>&ndash;&gt;-->\n<!--  </label>-->\n<!--  <div class=\"col-sm-8\">-->\n<!--    &lt;!&ndash;        <input #inputCity type=\"text\" class=\"col-sm-6 form-control form-control-sm\" id=\"inputCity\" [value]=\"model.city\" (input)=\"model.city=$event.target.value\" placeholder=\"Enter City Name\" [value]=\"inputCity.disabled? '' : inputCity.value\" [required]=\"!inputCity.disabled\" pattern=\"[a-zA-Z]+\">&ndash;&gt;-->\n<!--    <input #inputCity type=\"text\" class=\"col-sm-6 form-control form-control-sm\" id=\"inputCity\" (keyup)=\"suggestCities($event.target.value)\" [value]=\"model.city\" (input)=\"model.city=$event.target.value\" placeholder=\"Enter City Name\" [value]=\"inputCity.disabled? '' : inputCity.value\" [required]=\"!inputCity.disabled\" pattern=\".*[a-zA-Z]+.*\" [formControl]=\"control\" [matAutocomplete]=\"auto\" autoActiveFirstOption=true>-->\n<!--    <mat-autocomplete #auto=\"matAutocomplete\">-->\n<!--      <mat-option *ngFor=\"let c of cities$$ | async\" [value]=\"c\">-->\n<!--        {{c}}-->\n<!--      </mat-option>-->\n<!--    </mat-autocomplete>-->\n<!--  </div>-->\n<!--</div>-->\n\n<!--<p><i>Searches when typing stops. Caches for 30 seconds.</i></p>-->\n<!--<input ( id=\"name\" placeholder=\"Search\"/>-->\n<!--<input type=\"checkbox\" id=\"refresh\">-->\n<!--<label for=\"refresh\">with refresh</label>-->\n\n<!--<ul>-->\n<!--  <li *ngFor=\"let c of cities$$ | async\">-->\n<!--    <b>{{c.city}}</b>-->\n<!--  </li>-->\n<!--</ul>-->\n\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/current-tab-page/current-tab-page.component.html":
/*!********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/current-tab-page/current-tab-page.component.html ***!
  \********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!--<h3>Favorites</h3>-->\n<!--<br><br><br>-->\n<ng-container *ngIf=\"favorites.length==0\">\n  <div class=\"alert alert-warning\" role=\"alert\"><p>No records.</p></div>\n</ng-container>\n<div *ngIf=\"favorites.length>0\">\n  <div class=\"container-fluid\">\n  <div class=\"row\">\n    <div class='col-12'>\n      <!--<ng-template #favoritesTable>-->\n      <table class=\"table favorites-table-striped align-items-center justify-content-center\" id=\"favorites-table\">\n        <thead>\n        <tr class=\"align-items-center justify-content-center\">\n          <th scope=\"col\" [ngStyle]=\"{'text-align': 'center'}\">#</th>\n          <th scope=\"col\">Images</th>\n          <th scope=\"col\">City</th>\n          <th scope=\"col\">State</th>\n          <th scope=\"col\">Favorites</th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr *ngFor=\"let favorite of favorites ; index as i\">\n          <th scope=\"row\">{{ i + 1 }}</th>\n          <!--    <td>{{i+1}} </td>-->\n          <td><img class=\"state-seal-thumbnail\" src={{favorite.image}}></td>\n          <td ><a href=\"\"(click)=\"useFavorite(i)\" ngbTooltip={{favorite.city}} data-container=\"body\">{{favorite.city | titlecase}}</a></td>\n          <td ngbTooltip={{favorite.state}} data-container=\"body\">{{favorite.state}}</td>\n          <td><button (click)=\"delete(i)\"><i class=\"material-icons md-18\" >delete</i></button></td>\n\n          <!--    <td>-->\n          <!--      <img [src]=\"'https://upload.wikimedia.org/wikipedia/commons/' + country.flag\" class=\"mr-2\" style=\"width: 20px\">-->\n          <!--      {{ country.name }}-->\n          <!--    </td>-->\n          <!--    <td>{{ country.area | number }}</td>-->\n          <!--    <td>{{ country.population | number }}</td>-->\n        </tr>\n        </tbody>\n      </table>\n    </div>\n  </div>\n  </div>\n</div>\n<!--<mat-table [dataSource]=\"favorites\">-->\n<!--  &lt;!&ndash; User name Definition &ndash;&gt;-->\n<!--  <ng-container cdkColumnDef=\"username\">-->\n<!--    <mat-header-cell *cdkHeaderCellDef> City </mat-header-cell>-->\n<!--    <mat-cell *cdkCellDef=\"let row\"> {{row.city}} </mat-cell>-->\n<!--  </ng-container>-->\n\n<!--  &lt;!&ndash; Age Definition &ndash;&gt;-->\n<!--  <ng-container cdkColumnDef=\"age\">-->\n<!--    <mat-header-cell *cdkHeaderCellDef> state </mat-header-cell>-->\n<!--    <mat-cell *cdkCellDef=\"let row\"> {{row.state}} </mat-cell>-->\n<!--  </ng-container>-->\n\n<!--  &lt;!&ndash; Title Definition &ndash;&gt;-->\n<!--  <ng-container cdkColumnDef=\"title\">-->\n<!--    <mat-header-cell *cdkHeaderCellDef> Index </mat-header-cell>-->\n<!--    <mat-cell *cdkCellDef=\"let row\"> {{row.index}} </mat-cell>-->\n<!--  </ng-container>-->\n\n<!--  &lt;!&ndash; Header and Row Declarations &ndash;&gt;-->\n<!--  <mat-header-row *cdkHeaderRowDef=\"['username', 'age', 'title']\"></mat-header-row>-->\n<!--  <mat-row *cdkRowDef=\"let row; columns: ['username', 'age', 'title']\"></mat-row>-->\n<!--</mat-table>-->\n\n\n\n<!--<table id=\"favorite-places\">-->\n<!--  <tr>-->\n<!--    <th>#</th>-->\n<!--    <th>Images</th>-->\n<!--    <th>City</th>-->\n<!--    <th>State</th>-->\n<!--    <th>Favorites</th>-->\n<!--  </tr>-->\n<!--  <div *ngFor=\"let favorite of favorites; let i = index\">-->\n<!--  <tr>-->\n<!--    <td>{{i+1}} </td>-->\n<!--    <td><img src=\"#\"></td>-->\n<!--    <td><a href=\"#\"></a></td>-->\n<!--    <td>State</td>-->\n<!--    <td><button (click)=\"localStorageService.removeFavorite(favorite.city)\"><i class=\"material-icons md-18\" >delete</i></button></td>-->\n<!--  </tr>-->\n<!--  </div>-->\n<!--</table>-->\n\n<!--    -->\n<!--<div class=\"favorite-places\" *ngFor=\"let favorite of favorites| async ; let i = index \">-->\n<!--<span>{{i+1}} {{favorite.image}}</span>-->\n<!--<span></span>-->\n<!--</div>-->\n\n<!--  *ngFor=\"let favorite of favorites| async ; let i = index \">-->\n\n<!--<ng-container >-->\n<!--  <table class=\"table favorites-table-striped\">-->\n<!--    <thead>-->\n<!--    <tr>-->\n<!--      <th scope=\"col\">#</th>-->\n<!--      <th scope=\"col\">Images</th>-->\n<!--      <th scope=\"col\">City</th>-->\n<!--      <th scope=\"col\">State</th>-->\n<!--      <th scope=\"col\">Favorites</th>-->\n<!--    </tr>-->\n<!--    </thead>-->\n<!--    <tbody>-->\n<!--    <tr *ngFor=\"let favorite of list; index as i\">-->\n<!--      <th scope=\"row\">{{ i + 1 }}</th>-->\n<!--      &lt;!&ndash;    <td>{{i+1}} </td>&ndash;&gt;-->\n<!--      <td><img src=\"#\"></td>-->\n<!--      <td><a href=\"#\"></a></td>-->\n<!--      <td ngbTooltip={{favorite.state}}>State</td>-->\n<!--      <td><button (click)=\"localStorageService.removeFavorite(i)\"><i class=\"material-icons md-18\" >delete</i></button></td>-->\n\n<!--      &lt;!&ndash;    <td>&ndash;&gt;-->\n<!--      &lt;!&ndash;      <img [src]=\"'https://upload.wikimedia.org/wikipedia/commons/' + country.flag\" class=\"mr-2\" style=\"width: 20px\">&ndash;&gt;-->\n<!--      &lt;!&ndash;      {{ country.name }}&ndash;&gt;-->\n<!--      &lt;!&ndash;    </td>&ndash;&gt;-->\n<!--      &lt;!&ndash;    <td>{{ country.area | number }}</td>&ndash;&gt;-->\n<!--      &lt;!&ndash;    <td>{{ country.population | number }}</td>&ndash;&gt;-->\n<!--    </tr>-->\n<!--    </tbody>-->\n<!--  </table>-->\n\n<!--</ng-container>-->\n\n<!--<br>-->\n\n<!--<button mat-raised-button (click)=\"addColumn()\"> Add column </button>-->\n<!--<button mat-raised-button (click)=\"removeColumn()\"> Remove column </button>-->\n<!--<button mat-raised-button (click)=\"shuffle()\"> Shuffle </button>-->\n\n<!--<table mat-table [dataSource]=\"data$ | async\" class=\"mat-elevation-z8 favorites-table-striped\">-->\n<!--  <ng-container [matColumnDef]=\"column\" *ngFor=\"let column of displayedColumns; index as i\">-->\n<!--    <th mat-header-cell *matHeaderCellDef> {{column}} </th>-->\n<!--    <td mat-cell *matCellDef=\"let element\"> {{element[column]}} </td>-->\n<!--  </ng-container>-->\n<!--<button (click)=\"localStorageService.clearAllFavorites()\">Clear Local</button>-->\n\n<!--  <tr mat-header-row *matHeaderRowDef=\"columnsToDisplay\"></tr>-->\n<!--  <tr mat-row *matRowDef=\"let row; columns: columnsToDisplay;\"></tr>-->\n<!--</table>-->\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/hourly-tab-page/hourly-tab-page.component.html":
/*!******************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/hourly-tab-page/hourly-tab-page.component.html ***!
  \******************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container-fluid\">\n\n<br><br>\n<div class=\"row\">\n<div class=\"col-6\">\n<select class=\"custom-select\" id=\"hourlyParam\"  #hourlyParam (change)=\"updateSelectParam($event)\">\n  <option value=\"temperature\" selected>Temperature</option>\n  <option value=\"pressure\">Pressure</option>\n  <option value=\"humidity\">Humidity</option>\n  <option value=\"ozone\">Ozone</option>\n  <option value=\"visibility\">Visibility</option>\n  <option value=\"windSpeed\">Wind Speed</option>\n</select>\n</div>\n</div>\n\n<!--<p>You selected: {{selectedParamVal }}</p>-->\n<!--<p>You selected$: {{selectedParamVal$ }}</p>-->\n  <div class=\"col-sm-12 col-md-10\">\n<div class=\"chart-wrapper\">\n  <canvas id=\"barChart \"#barChart> {{chart}}\n<!--    <canvas baseChart-->\n    <!--          [datasets]=\"getBarChartData()\"-->\n<!--          [labels]=\"getBarChartLabels()\"-->\n<!--          [options]=\"barChartOptions\"-->\n<!--          [plugins]=\"barChartPlugins\"-->\n<!--          [legend]=\"barChartLegend\"-->\n<!--          [chartType]=\"barChartType\">-->\n  </canvas>\n</div>\n</div>\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/ip-location/ip-location.component.html":
/*!**********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/ip-location/ip-location.component.html ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n<p>Test ip-location component</p>\n<p>Lat: {{lat}}<br> Lon: {{lon}}<br> City: {{city}}<br>State: {{state}}{{ip}}</p>\n\n<!--<button *ngIf=\"model.auto\" class=\"btn btn-outline-dark btn-light\" type=\"button\" name=\"submitAuto\" id=\"submitAuto\" #submitAuto (click)=\"checkForm('use_current',submitAuto.name)\"><i class=\"material-icons md-18\" >search</i>Search </button>-->\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"isLoading | async\" class=\"loader-overlay\">\n  <mat-progress-bar class=\"loader-progress-bar\" mode=\"indeterminate\"></mat-progress-bar>\n\n</div>\n<!--<div class=\"progress-loader\" [hidden]=\"!isLoading\">-->\n<!--  Loading...-->\n<!--</div>-->\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/results-page/results-page.component.html":
/*!************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/results-page/results-page.component.html ***!
  \************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ng-container *ngIf=\"weatherData && locationData.lat!==''\">\n<mat-toolbar id=\"right-side-buttons\">\n  <div class=\"logo-wrapper\">\n    <!-- <a class=\"twitter-share-button\"-->\n<!--    <a href=\"https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20\" id=\"twitter-logo\">-->\n<!--         <a href=\"https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20\"+{{locationData.city}} + \"%20is%20\" + {{weatherData.temperature}} +'.%20The%20weather%20conditions%20are%20\" +{{weatherData.summary}} +\".\">-->\n    <a [href]=\"getTweet()\">\n    <img class=\"img-thumbnail\" src=\"http://csci571.com/hw/hw8/Images/Twitter.png\">\n    </a>\n  </div>\n  <ng-container [ngSwitch]=\"isStarred\">\n    <button *ngSwitchCase=\"true\" class=\"star-icon\" (click)=\"unstar()\"><i  id=\"star-filled\" class=\"material-icons md-48\">star</i></button>\n    <button *ngSwitchDefault class=\"star-icon\" (click)=\"star()\"><i id=\"star-outline\" class=\"material-icons md-48\">star_border</i></button>\n  </ng-container>\n<!--  <button class=\"star-icon\" *ngIf=\"isStarred\" (click)=\"unstar()\"><i  id=\"star-filled\" class=\"material-icons md-48\">star</i></button>-->\n<!--  <button class=\"star-icon\" *ngIf=\"!isStarred\" (click)=\"star()\"><i id=\"star-outline\" class=\"material-icons md-48\">star_border</i></button>-->\n\n</mat-toolbar>\n<ngb-tabset id=\"resultsTabset\" justify=\"left\" activeId=\"currentTab\">\n\n  <ngb-tab id=\"currentTab\" name=\"currentTab\" title=\"Current\">\n\n      <ng-template ngbTabContent>\n<!--    <app-current-tab-page [stateSealImg]=\"stateSealImg\"></app-current-tab-page>-->\n        <div id=\"tab1\" class=\"container-fluid\" *ngIf=\"weatherData && locationData.lat!==''\" >\n          <div class='card1'>\n            <div class=\"row\">\n              <div class = \"col-7\"><div class=\"card1-text\">\n            <div class=\"city-text\">{{locationData.city | titlecase}}</div>\n            <div class=\"timezone-text\">{{weatherData.currently.timezone}}</div>\n            <div id='card1-temp'> {{weatherData.currently.temperature | number: \"1.0-0\"}} &deg;F </div>\n            <div class=\"summary-text\"> {{weatherData.currently.summary}} </div>\n              </div></div>\n            <div class=\"col-5\">\n              <div class=\"card1 state-seal\" *ngIf=\"stateSealImg\">\n                <img [src]=\"stateSealImg\" id=\"state-seal-img\" alt=\"Image of State Seal\">\n              </div>\n            </div>\n            </div>\n              <div id='card1-icon-row' class=\"row\">\n                <div class=\"col-12\">\n            <table id='card1-table'>\n              <tr>\n              <td class='col-6' ngbTooltip='Humidity'><span id='humidity' class='icon'><p> {{weatherData.currently.humidity || \"NA\"}}</p></span></td>\n              <td class='col-6' ngbTooltip='Pressure'><span id='pressure' class='icon'><p> {{weatherData.currently.pressure|| \"NA\"}} </p></span></td>\n              <td class='col-6' ngbTooltip='Wind Speed'><span id='windspeed' class='icon'><p> {{weatherData.currently.windSpeed|| \"NA\"}} </p></span></td>\n              <td class='col-6' ngbTooltip='Visibility'><span id='visibility' class='icon'><p> {{weatherData.currently.visibility|| \"NA\"}} </p></span></td>\n              <td class='col-6' ngbTooltip='Cloud Cover'><span id='cloudcover' class='icon'><p> {{weatherData.currently.cloudCover|| \"NA\"}} </p></span></td>\n              <td class='col-6' ngbTooltip='Ozone'><span id='ozone' class='icon'><p> {{weatherData.currently.ozone|| \"NA\"}} </p></span></td>\n            </tr>\n            </table>\n                </div>\n              </div>\n            </div>\n          </div>\n<!--          </div>-->\n<!--          <div class=\"card1\">-->\n<!--            <div class=\"card-body p-3 mb-5 bg-sky\">-->\n<!--              <div class=\"card-header border-0\">-->\n\n<!--              </div>-->\n<!--              <div class=\"card-text\">-->\n<!--                <div class=\"row\">-->\n<!--                  <div class=\"col-sm-7\">-->\n<!--                  </div>-->\n<!--                <div class=\"col-sm-5 border-0\" *ngIf=\"stateSealImg\">-->\n<!--                  <img src={{stateSealImg.src}} >-->\n<!--                </div>-->\n<!--                </div>-->\n\n<!--            </div>-->\n<!--          </div>-->\n<!--        </div>-->\n\n\n      </ng-template>\n  </ngb-tab>\n\n  <ngb-tab id=\"hourlyTab\" name=\"hourlyTab\" title=\"Hourly\">\n    <ng-template ngbTabContent>\n\n      <app-hourly-tab-page [hourlyData]=\"weatherData.hourly\"></app-hourly-tab-page>\n\n<!--      <app-hourly-tab-page [selected]=\"getParamData()\" [hourlyData]=\"weatherData.hourly\"></app-hourly-tab-page>-->\n    </ng-template>\n  </ngb-tab>\n\n  <ngb-tab id=\"weeklyTab\" name=\"weeklyTab\" title=\"Weekly\">\n    <ng-template ngbTabContent>\n      <app-weekly-tab-page [locationData]=this.locationData [weeklyData]=\"weatherData.weekly\"></app-weekly-tab-page>\n    </ng-template>\n  </ngb-tab>\n\n<!--  <ngb-tab>-->\n<!--    <ng-template ngbTabTitle>-->\n<!--      <button class=\"star-icon\"><i  id=\"star-filled\" class=\"material-icons md-48\">star</i></button>-->\n<!--      <button class=\"star-icon\" ><i id=\"star-outline\" class=\"material-icons md-48\">star_border</i></button>-->\n\n<!--      <span class=\"logo-wrapper\">-->\n<!--        &lt;!&ndash; <a class=\"twitter-share-button\"&ndash;&gt;-->\n<!--        <a href=\"https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20\" id=\"twitter-logo\">-->\n<!--          &lt;!&ndash;   href=\"https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20\"+{{locationData.city}} + \"%20is%20\" + {{weatherData.temperature}} +'.%20The%20weather%20conditions%20are%20\" +{{weatherData.summary}} +\".\">&ndash;&gt;-->\n<!--          <img class=\"img-thumbnail\" src=\"http://csci571.com/hw/hw8/Images/Twitter.png\">-->\n<!--        </a>-->\n<!--      </span>-->\n<!--    </ng-template>-->\n<!--  </ngb-tab>-->\n</ngb-tabset>\n\n<!--&lt;!&ndash;use ngSwitch&ndash;&gt;-->\n<!--<mat-toolbar>-->\n<!--  <button id=\"star-filled\"><i class=\"material-icons md-18\">star</i></button>-->\n<!--<button id=\"star=outline\"><i class=\"material-icons md-18\">star_border</i></button>-->\n\n<!--  <div class=\"logo-wrapper\">-->\n<!--  &lt;!&ndash; <a class=\"twitter-share-button\"&ndash;&gt;-->\n<!--  <a href=\"https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20\" id=\"twitter-logo\">-->\n<!--    &lt;!&ndash;   href=\"https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20\"+{{locationData.city}} + \"%20is%20\" + {{weatherData.temperature}} +'.%20The%20weather%20conditions%20are%20\" +{{weatherData.summary}} +\".\">&ndash;&gt;-->\n<!--    <img class=\"img-thumbnail\" src=\"http://csci571.com/hw/hw8/Images/Twitter.png\">-->\n<!--  </a>-->\n<!--</div>-->\n<!--</mat-toolbar>-->\n<!--</div>-->\n</ng-container>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/weather-search/weather-search.component.html":
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/weather-search/weather-search.component.html ***!
  \****************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n<div id=\"'search-form\" class=\"container ml-auto\" >\n\n  <div class=\"card mt-5 border-0\">\n    <div class=\"card-body p-3 mb-5 bg-navy shadow\">\n      <div class=\"card-header border-0\">\n        <h1>Weather Search</h1>\n      </div>\n      <div class=\"card-text\">\n\n        <form id=\"inputForm\" name=\"inputForm\" class=\"form\" #inputForm (ngSubmit)=\"onSubmit($event,submitBtnName)\" (reset)=\"resetSearchForm()\">\n\n          <fieldset id=\"manualInput\" #manualInput [disabled]=\"autoInput.checked ? true: false\">\n            <div class=\"form-group row\" >\n              <label for=\"inputStreet\" class=\"col-sm-2 offset-2 col-form-label\">Street\n                <p class=\"is-invalid\">*</p>\n              </label>\n              <div class=\"col-sm-8\">\n                <input class=\"form-control form-control-sm col-sm-6\"\n                       #inputStreet type=\"text\" id=\"inputStreet\" name=\"inputStreet\" placeholder=\"Enter Street Name\" required pattern=\".*[a-zA-Z]+.*\"\n                       [value]=\"model.street\" (input)=\"model.street=$event.target.value\" ngModel>\n                <p *ngIf=\"(!inputStreet.checkValidity() && !autoInput.checked)\" class=\"has-text invalid\">Please enter a street</p>\n              </div>\n            </div>\n            <div class=\"form-group row\">\n              <label for=\"inputCity\" class=\"col-sm-2 offset-2 col-form-label\">City\n                <p class=\"is-invalid\">*</p>\n              </label>\n              <div class=\"col-sm-8\">\n                <input type=\"text\" class=\"col-sm-6 form-control form-control-sm\" matInput #inputCity [(ngModel)]=\"model.city\" (keyup)=\"suggestCities(inputCity.value)\" id=\"inputCity\" name=\"inputCity\" [value]=\"model.city\" (input)=\"model.city=$event.target.value\" placeholder=\"Enter City Name\"  [required]=\"!inputCity.disabled\" pattern=\".*[a-zA-Z]+.*\" [matAutocomplete]=\"auto\" >\n                <mat-autocomplete #auto=\"matAutocomplete\" autoActiveFirstOption>\n                  <mat-option *ngFor=\"let suggestion of suggestions$ | async\" value={{suggestion.city}}>\n                    {{suggestion.city }}\n                  </mat-option>\n                </mat-autocomplete>\n                <p *ngIf=\"(!inputCity.checkValidity() && !autoInput.checked)\" class=\"has-text invalid\">Please enter a city</p>\n              </div>\n            </div>\n\n            <div class=\"form-group row\" >\n              <label for=\"inputState\" class=\"col-sm-2 offset-2 col-form-label\">State <p *ngIf=\"inputState.checkValidity()==false\" class=\"is-invalid\">*</p></label>\n              <div class=\"col-sm-8\">\n                <select  [(ngModel)]=\"model.state\" #selectState=\"ngModel\" id=\"selectState\" name=\"selectState\" class=\"form-control custom-select custom-select-sm col-sm-4 \"  (change)=\"chooseState($event)\" *ngIf=\"arrStates\" [required]=\"!selectState.disabled\" autocomplete=\"off\">\n                  <option value=\"\">Select State</option>\n                  <option *ngFor=\"let s of arrStates\" [value]=\"s.Abbreviation\">{{s.State}}</option>\n                </select>\n              </div>\n            </div>\n            <input type=\"hidden\" id=\"hiddenStreet\" (change)=\"0\" [value]=\"inputStreet.value\" >\n            <input type=\"hidden\" id=\"hiddenCity\" (change)=\"0\" [value]=\"inputCity.value\" >\n            <input #inputState type=\"hidden\" id=\"inputState\" (change)=\"0\" [value]=\"inputtedState\" >\n          </fieldset>\n\n          <fieldset id=\"autoLocation\">\n            <div class=\"form-group row\">\n              <div class=\"col-sm-6 offset-2 form-check\" >\n                <div class=\"form-check-inline\">\n                  <label class=\"form-check-label\" for=\"autoInput\" >\n                    <input class=\"form-check-input\" type=\"checkbox\" [checked]=\"model.auto\" id=\"autoInput\" name=\"autoInput\" [value]=\"autoInput.checked\" (change)=\"toggleFields($event)\" #autoInput [required]=\"manualInput.disabled\"> Current location\n                  </label>\n                </div>\n\n              </div>\n            </div>\n          </fieldset>\n          <div class=\"row\">\n          <div class=\"btn-toolbar offset-2\" role=\"toolbar\" aria-label=\"submit and clear buttons\" >\n            <button *ngIf=\"model.auto\" class=\"btn btn-outline-dark btn-light\" type=\"button\" name=\"submitAuto\" id=\"submitAuto\" #submitAuto (click)=\"checkForm('use_current',submitAuto.name)\"><i class=\"material-icons md-18\" >search</i>Search </button>\n            <button *ngIf=\"model.street.length>0 && model.city.length>0 && model.state.length>0 && !model.auto\" class=\"btn btn-outline-dark btn-light\" type=\"button\" name=\"submitManual\" id=\"submitManual\" #submitManual (mousedown)= \"checkForm(manualInput.children, submitManual.name)\" [disabled]=\"!(inputStreet.checkValidity() && inputCity.checkValidity() && (inputState.value.length>0))\" ><i class=\"material-icons md-18\" >search</i>Search </button>\n            <button *ngIf=\"!model.auto && !(model.street.length>0 && model.city.length>0 && model.state.length>0)\" class=\"btn btn-outline-dark btn-light\" type=\"button\" [disabled]=\"true\"><i class=\"material-icons md-18\" >search</i>Search </button>\n\n            <button class=\"btn btn-outline-dark btn-light\" type=\"button\" (click)=\"resetSearchForm()\"><i class=\"material-icons md-18\" >clear_all</i>Clear</button>\n          </div>\n          </div>\n        </form>\n\n        </div>\n      </div>\n\n    </div>\n\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/weekly-tab-page/modal-options.html":
/*!******************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/weekly-tab-page/modal-options.html ***!
  \******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!--<ng-template *ngIf=\"dayData | async\" #weeklyModal let-modal id=\"weeklyModal\">-->\n\n<!--  <div class=\"modal-header weekly-modal\">-->\n<!--    <h4 class=\"modal-title\">{{dayData$.time * 1000 | date: 'M/d/yyyy'}}</h4>-->\n<!--    <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"modal.dismiss('Cross click');\">-->\n<!--      <span aria-hidden=\"true\">&times;</span>-->\n<!--    </button>-->\n<!--  </div>-->\n\n<!--  <div class=\"modal-body weekly-modal\">-->\n<!--    <div class=\"row\">-->\n<!--      <div class=\"col-6\">-->\n<!--        <div class=\"modal-city\">{{locationData.city}}</div>-->\n<!--        <div class=\"modal-temp\">{{dayData$.temperature}} &deg;F</div>-->\n<!--        <div class=\"modal-summary\">{{dayData$.summary}}</div>-->\n<!--      </div>-->\n<!--      <div class=\"col-6\">-->\n<!--        <div class=\"modal-icon\">-->\n<!--          <img src=\"https://cdn3.iconfinder.com/data/icons/weather-344/142/sun-512.png\"-->\n<!--               alt=\"icon for current conditions\" width=\"100%\" height=\"auto\">-->\n<!--          &lt;!&ndash;          <div id=\"weeklyIconWrapper\">&ndash;&gt;-->\n<!--          &lt;!&ndash;                          <div id=\"c3-clear\"></div>&ndash;&gt;-->\n<!--        </div>-->\n<!--        &lt;!&ndash;        </div>&ndash;&gt;-->\n\n<!--      </div>-->\n<!--    </div>-->\n<!--  </div>-->\n\n<!--  <div class=\"modal-footer weekly-modal\">-->\n<!--    <div class=\"offset-6 col-6\">-->\n<!--      <p>Precipitation : &#45;&#45; </p>-->\n<!--      <p>Change of Rain : &#45;&#45; %</p>-->\n<!--      <p>Wind Speed : &#45;&#45; mph</p>-->\n<!--      <p>Humidity : &#45;&#45; %</p>-->\n<!--      <p>Visibility : &#45;&#45; miles</p>-->\n<!--    </div>-->\n<!--  </div>-->\n<!--</ng-template>-->\n<!--<ng-template #content let-c=\"close\" let-d=\"dismiss\">-->\n<!--  <div class=\"modal-header\">-->\n<!--    <h4 class=\"modal-title\" id=\"modal-basic-title\">Hi there!</h4>-->\n<!--    <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"d('Cross click')\">-->\n<!--      <span aria-hidden=\"true\">&times;</span>-->\n<!--    </button>-->\n<!--  </div>-->\n<!--  <div class=\"modal-body\">-->\n<!--    <p>Hello, World!</p>-->\n<!--  </div>-->\n<!--  <div class=\"modal-footer\">-->\n<!--    <button type=\"button\" class=\"btn btn-outline-dark\" (click)=\"c('Save click')\">Save</button>-->\n<!--  </div>-->\n<!--</ng-template>-->\n\n<!--<button class=\"btn btn-lg btn-outline-primary\" (click)=\"openModalService(content)\">Launch demo modal</button>-->\n<script src=\"../../../../deployed/server.js\"></script>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/weekly-tab-page/weekly-tab-page.component.html":
/*!******************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/weekly-tab-page/weekly-tab-page.component.html ***!
  \******************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container-fluid\" #weeklyChart>\n  <div id=\"chartContainer\" style=\"height: 370px; width: 100%;\" data-target=\"weeklyModal\"></div>\n  <ng-template #weeklyModal let-modal id=\"weeklyModal\">\n    <div class=\"modal-header weekly-modal\">\n      <h4 class=\"modal-title\">{{content.time*1000 | date: 'd/M/yyyy'}}</h4>\n      <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"modal.dismiss('Cross click');\">\n        <span aria-hidden=\"true\">&times;</span>\n      </button>\n    </div>\n\n    <div class=\"modal-body weekly-modal\">\n      <div class=\"row\">\n        <div class=\"col-6\">\n          <div class=\"modal-city\">{{locationData.city}}</div>\n          <div class=\"modal-temp\">{{content.temperature | number: \"1.0-0\"}} &deg;F</div>\n          <div class=\"modal-summary\">{{content.summary}}</div>\n        </div>\n        <div class=\"col-6\">\n          <div class=\"modal-icon\" >\n            <img [src]=\"getIcon(content.icon)\" alt=\"icon for current conditions\" width=\"100%\" height=\"auto\">\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"modal-footer weekly-modal\">\n      <div class=\"offset-6 col-6 mr-2\" id=\"modal-forcast-details\">\n        <p>Precipitation : {{content?.precipitation| percent: \"1.0-2\"}}</p>\n        <p>Chance of Rain : {{content?.chanceOfRain| percent: \"1.0-2\"}}</p>\n        <p>Wind Speed : {{content?.windspeed| number: \"1.0-2\"}} mph</p>\n        <p>Humidity : {{content?.humidity| number: \"1.0-2\"}} %</p>\n        <p>Visibility : {{content?.visibility| number: \"1.0-2\"}} miles</p>\n      </div>\n<!--    <h4 class=\"modal-title\">{{dayData$.time*1000 | date: 'M/d/yyyy'}}</h4>-->\n<!--    <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"modal.dismiss('Cross click');\">-->\n<!--      <span aria-hidden=\"true\">&times;</span>-->\n<!--    </button>-->\n<!--  </div>-->\n\n<!--  <div class=\"modal-body weekly-modal\">-->\n<!--    <div class=\"row\">-->\n<!--      <div class=\"col-6\">-->\n<!--        <div class=\"modal-city\">{{locationData.city}}</div>-->\n<!--        <div class=\"modal-temp\">{{dayData.temperature}} &deg;F</div>-->\n<!--        <div class=\"modal-summary\">{{dayData.summary}}</div>-->\n<!--      </div>-->\n<!--      <div class=\"col-6\">-->\n<!--        <div class=\"modal-icon\" >-->\n<!--          <img src=\"https://cdn3.iconfinder.com/data/icons/weather-344/142/sun-512.png\" alt=\"icon for current conditions\" width=\"100%\" height=\"auto\">-->\n\n<!--        </div>-->\n<!--        &lt;!&ndash;        </div>&ndash;&gt;-->\n\n<!--      </div>-->\n<!--    </div>-->\n<!--  </div>-->\n\n<!--  <div class=\"modal-footer weekly-modal\">-->\n<!--    <div class=\"offset-6 col-6\">-->\n<!--      <p>Precipitation : &#45;&#45; </p>-->\n<!--      <p>Change of Rain : &#45;&#45; %</p>-->\n<!--      <p>Wind Speed : &#45;&#45; mph</p>-->\n<!--      <p>Humidity : &#45;&#45; %</p>-->\n<!--      <p>Visibility : &#45;&#45; miles</p>-->\n<!--    </div>-->\n  </div>\n</ng-template>\n</div>\n<!--  <ng-template  *ngFor=\"let item of dayData | async\" #weeklyModal let-modal id=\"weeklyModal\" >-->\n\n<!--    <div class=\"modal-header weekly-modal\">-->\n<!--      <h4 class=\"modal-title\">{{dayData$.time*1000 | date: 'M/d/yyyy'}}</h4>-->\n<!--      <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"modal.dismiss('Cross click');\">-->\n<!--        <span aria-hidden=\"true\">&times;</span>-->\n<!--      </button>-->\n<!--    </div>-->\n\n<!--    <div class=\"modal-body weekly-modal\">-->\n<!--      <div class=\"row\">-->\n<!--        <div class=\"col-6\">-->\n<!--          <div class=\"modal-city\">{{locationData.city}}</div>-->\n<!--          <div class=\"modal-temp\">{{dayData$.temperature}} &deg;F</div>-->\n<!--          <div class=\"modal-summary\">{{dayData$.summary}}</div>-->\n<!--        </div>-->\n<!--        <div class=\"col-6\">-->\n<!--             <div class=\"modal-icon\" >-->\n<!--               <img src=\"https://cdn3.iconfinder.com/data/icons/weather-344/142/sun-512.png\" alt=\"icon for current conditions\" width=\"100%\" height=\"auto\">-->\n<!--&lt;!&ndash;          <div id=\"weeklyIconWrapper\">&ndash;&gt;-->\n<!--&lt;!&ndash;                          <div id=\"c3-clear\"></div>&ndash;&gt;-->\n<!--          </div>-->\n<!--&lt;!&ndash;        </div>&ndash;&gt;-->\n\n<!--        </div>-->\n<!--      </div>-->\n<!--    </div>-->\n\n<!--    <div class=\"modal-footer weekly-modal\">-->\n<!--        <div class=\"offset-6 col-6\">-->\n<!--          <p>Precipitation : &#45;&#45; </p>-->\n<!--          <p>Change of Rain : &#45;&#45; %</p>-->\n<!--          <p>Wind Speed : &#45;&#45; mph</p>-->\n<!--          <p>Humidity : &#45;&#45; %</p>-->\n<!--          <p>Visibility : &#45;&#45; miles</p>-->\n<!--        </div>-->\n<!--    </div>-->\n<!--  </ng-template>-->\n<!--&lt;!&ndash;</ng-container>&ndash;&gt;-->\n<!--</div>-->\n");
...
let ApiService = class ApiService {
    ...
    getLatLon(street, city, state) {
        ...
        console.log('getLatLon url:', URL);
        return this.http.get(URL);
    }
    autoLocate() {
        return this.http.jsonp('http://ip-api.com/json/', 'callback');
    }
    getWeather(lat, lon) {
        if (lat && lon) {
            const backendUrl = 'api/weather?location=' + lat + ',' + lon;
            console.log('calling backendURL: ' + backendUrl);
            return this.http.get(backendUrl, { responseType: 'json' });
        }
    }
    getStateSeal(state) {
        let apiURL = 'api/state-seal?state=' + state;
        console.log('getting state seal', apiURL);
        return this.http.get(apiURL, { responseType: 'text' });
    }
    getWeatherDetails(lat, lon, day) {
        const backendUrl = 'api/forecast?location=' + lat + ',' + lon + '&day=' + day;
        console.log('calling backendURL: ' + backendUrl);
        return this.http.get(backendUrl, { responseType: 'json' });
    }
};
...
let AppComponent = class AppComponent {
    ...
    hideProgressBar() {
        console.log('mat-loader', this.loadingBarService);
    }
    useStoredLocation($event) {
        this.savedLocation = $event;
        console.log('child parent stored location', this.savedLocation);
        this.autoFill = {
            method: 'saved',
            lat: this.savedLocation.lat,
            lon: this.savedLocation.lon,
            city: this.savedLocation.city,
            state: this.savedLocation.state
        };
        // this.FORM=this.autoFillForm;
        // this.FORM.submitted = true;
        // this.showResults.emit(this.autoFill);
...
], AppComponent.prototype, "showResults", void 0);
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-root',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./app.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/app.component.html")).default,
        animations: [
            Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["trigger"])('insertRemoveTrigger', [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["transition"])(':enter', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["style"])({ opacity: 0 }),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["animate"])('500ms 3s', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["style"])({ opacity: 1 })),
                ]),
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["transition"])(':leave', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["animate"])('5s', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["style"])({ opacity: 0 }))
                ])
            ])
        ]
        // providers: [NgbProgressbarConfig, LoaderService]
    })
], AppComponent);
...
// }
// }
//   // SAMPLE CODE FOR LOAD PROGRESS BAR
...
/* harmony import */ var _ngx_loading_bar_http_client__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngx-loading-bar/http-client */ "./node_modules/@ngx-loading-bar/http-client/fesm2015/ngx-loading-bar-http-client.js");
...
/* harmony import */ var _tabset_config_tabset_config_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./tabset-config/tabset-config.component */ "./src/app/tabset-config/tabset-config.component.ts");
...
/* harmony import */ var _results_page_results_page_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./results-page/results-page.component */ "./src/app/results-page/results-page.component.ts");
/* harmony import */ var _current_tab_page_current_tab_page_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./current-tab-page/current-tab-page.component */ "./src/app/current-tab-page/current-tab-page.component.ts");
/* harmony import */ var _hourly_tab_page_hourly_tab_page_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./hourly-tab-page/hourly-tab-page.component */ "./src/app/hourly-tab-page/hourly-tab-page.component.ts");
/* harmony import */ var _weekly_tab_page_weekly_tab_page_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./weekly-tab-page/weekly-tab-page.component */ "./src/app/weekly-tab-page/weekly-tab-page.component.ts");
...
/* harmony import */ var _autocomplete_autocomplete_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./autocomplete/autocomplete.service */ "./src/app/autocomplete/autocomplete.service.ts");
/* harmony import */ var _ip_location_ip_location_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./ip-location/ip-location.component */ "./src/app/ip-location/ip-location.component.ts");
...
/* harmony import */ var _loader_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./loader.service */ "./src/app/loader.service.ts");
/* harmony import */ var _loader_interceptor__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./loader.interceptor */ "./src/app/loader.interceptor.ts");
/* harmony import */ var _weather_search_weather_search_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./weather-search/weather-search.component */ "./src/app/weather-search/weather-search.component.ts");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./api.service */ "./src/app/api.service.ts");
...
/* harmony import */ var _weekly_tab_page_modal_options_module__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./weekly-tab-page/modal-options.module */ "./src/app/weekly-tab-page/modal-options.module.ts");
...
// import { InputLocationFormComponent } from './input-location-form/input-location-form.component';
...
const routes = [
    { path: 'favorites', component: _favorites_page_favorites_page_component__WEBPACK_IMPORTED_MODULE_11__["FavoritesPageComponent"], outlet: 'favorites' },
    { path: 'results', component: _results_page_results_page_component__WEBPACK_IMPORTED_MODULE_12__["ResultsPageComponent"], outlet: 'results', redirectTo: '' },
    {
        path: 'search',
        component: _weather_search_weather_search_component__WEBPACK_IMPORTED_MODULE_27__["WeatherSearchComponent"],
        data: { title: 'States' }
    },
    {
...
const subroutes = [
    ...
    },
    {
        path: 'results',
        outlet: 'results',
        component: _results_page_results_page_component__WEBPACK_IMPORTED_MODULE_12__["ResultsPageComponent"],
        children: [
            {
                path: '/currently',
                component: _current_tab_page_current_tab_page_component__WEBPACK_IMPORTED_MODULE_13__["CurrentTabPageComponent"],
                outlet: 'currently'
            },
            {
                path: '/hourly',
                component: _hourly_tab_page_hourly_tab_page_component__WEBPACK_IMPORTED_MODULE_14__["HourlyTabPageComponent"],
                outlet: 'hourly'
            },
            {
                path: '/weekly',
                component: _weekly_tab_page_weekly_tab_page_component__WEBPACK_IMPORTED_MODULE_15__["WeeklyTabPageComponent"],
                outlet: 'weekly'
            }
        ]
    },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _tabset_config_tabset_config_component__WEBPACK_IMPORTED_MODULE_10__["TabsetConfigComponent"],
            _favorites_page_favorites_page_component__WEBPACK_IMPORTED_MODULE_11__["FavoritesPageComponent"],
            _results_page_results_page_component__WEBPACK_IMPORTED_MODULE_12__["ResultsPageComponent"],
            _current_tab_page_current_tab_page_component__WEBPACK_IMPORTED_MODULE_13__["CurrentTabPageComponent"],
            _hourly_tab_page_hourly_tab_page_component__WEBPACK_IMPORTED_MODULE_14__["HourlyTabPageComponent"],
            _weekly_tab_page_weekly_tab_page_component__WEBPACK_IMPORTED_MODULE_15__["WeeklyTabPageComponent"],
            _autocomplete_autocomplete_component__WEBPACK_IMPORTED_MODULE_21__["AutocompleteComponent"],
            _ip_location_ip_location_component__WEBPACK_IMPORTED_MODULE_23__["IpLocationComponent"],
            _loader_loader_component__WEBPACK_IMPORTED_MODULE_24__["LoaderComponent"],
            _weather_search_weather_search_component__WEBPACK_IMPORTED_MODULE_27__["WeatherSearchComponent"],
        ],
        imports: [
            ...
            _weekly_tab_page_modal_options_module__WEBPACK_IMPORTED_MODULE_32__["NgbdModalOptionsModule"],
        ...
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_17__["MatAutocompleteModule"]],
        providers: [
            _autocomplete_autocomplete_service__WEBPACK_IMPORTED_MODULE_22__["AutocompleteService"],
            _loader_service__WEBPACK_IMPORTED_MODULE_25__["LoaderService"], { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _loader_interceptor__WEBPACK_IMPORTED_MODULE_26__["LoaderInterceptor"], multi: true },
            // {
            //   provide: HTTP_INTERCEPTORS,
            //   useClass: InterceptorService,
            //   multi: true
            // },
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbProgressbarConfig"],
            _api_service__WEBPACK_IMPORTED_MODULE_28__["ApiService"]
        ],
        bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"]],
        entryComponents: [_weekly_tab_page_weekly_tab_page_component__WEBPACK_IMPORTED_MODULE_15__["WeeklyTabPageComponent"], _favorites_page_favorites_page_component__WEBPACK_IMPORTED_MODULE_11__["FavoritesPageComponent"], _autocomplete_autocomplete_component__WEBPACK_IMPORTED_MODULE_21__["AutocompleteComponent"]],
...
/* harmony import */ var _autocomplete_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./autocomplete.service */ "./src/app/autocomplete/autocomplete.service.ts");
...
let AutocompleteComponent = class AutocompleteComponent {
    ...
    suggestCities(letters) {
        this.searchText$.next(letters);
    }
    ngOnInit() {
        this.cities$ = this.searchText$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(letters => this.searchService.suggestCity(letters)));
    }
};
AutocompleteComponent.ctorParameters = () => [
    { type: _autocomplete_service__WEBPACK_IMPORTED_MODULE_4__["AutocompleteService"] }
];
AutocompleteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-autocomplete',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./autocomplete.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/autocomplete/autocomplete.component.html")).default,
        providers: [_autocomplete_service__WEBPACK_IMPORTED_MODULE_4__["AutocompleteService"]]
    })
...
/***/ "./src/app/autocomplete/autocomplete.service.ts":
/*!******************************************************!*\
  !*** ./src/app/autocomplete/autocomplete.service.ts ***!
  \******************************************************/
/*! exports provided: autocompleteUrl, AutocompleteService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const autocompleteUrl = '/api/autocomplete?city=';
function createHttpOptions(letters) {
...
let AutocompleteService = class AutocompleteService {
    ...
    suggestCity(letters) {
        ...
        const options = createHttpOptions(letters);
        const apiUrl = autocompleteUrl + letters;
        console.log('(autocomplete service) get: ', apiUrl);
        return this.http.get(apiUrl, options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => {
            return data.suggestions.map((entry) => ({
                city: entry
            }));
            // catchError(this.handleError('suggestCity', []))
        }));
    }
    // .map(res=>{return res.json()});
    getSuggestCity(letters) {
        // suggestCity(letters: string): void {
        // clear if no pkg name
        if (!letters.trim()) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])([]);
        }
        // const options = createHttpOptions(letters);
        const curl = autocompleteUrl + letters;
        console.log(curl);
        return this.http.get(curl).subscribe(data => {
            console.log(data);
            return data;
            // return this.http.get(curl).subscribe((resp: any) => {this.cities = resp.suggestions;
            //   console.log(this.cities);
            //   return this.cities;
        });
        // console.log(this.cities,'otuside');
        // return this.cities;
        // this.suggestions = this.suggestions.map(value => {
        //   city:value
        // });
...
//
//   suggestCityBackup(letters: string): Observable<AutocompleteCities[]> {
//     // suggestCity(letters: string): void {
//     // clear if no pkg name
//     if (!letters.trim()) {
//       return of([]);
//     }
//     // const options = createHttpOptions(letters);
//     let curl = autocompleteUrl + letters;
//     console.log(curl);
//     this.http.get(curl).subscribe((resp: any) => {
//       this.cities = resp.suggestions;
//     });
//     console.log(this.cities);
//     this.suggestions = this.cities.map(value => {
//       city:value;
//     });
//     return this.suggestions;
//   }
// }
//
// ) =resp.suggestions as AutocompleteCities[];
//   }, )
// return this.http.get(curl).pipe(
//   map((data: any) => {
//     return data.suggestions.map((entry: any) => ({
//         city: entry
//       } as AutocompleteCities)
//     );
//   }),
...
// let curl = autocompleteUrl + letters;
//
// return this.http.get(curl).subscribe(
//   data => {
//     this.suggested = data.suggestions as string [];
//   },
//   (err: HttpErrorResponse) => {
//     console.log(err.message);
//   }
...
// }
//
// suggestCity(letters: string): Observable<AutocompleteCities[]> {
//   // clear if no pkg name
//   if (!letters.trim()) {
//   return of([]);
// }
...
// let curl = autocompleteUrl + letters;
//
// return this.http.get(curl, options).pipe(
//   map((data: any) => {
//     return data.suggestions.map((entry: any) => ({
//         city: entry
//       } as AutocompleteCities)
...
/***/ "./src/app/current-tab-page/current-tab-page.component.css":
/*!*****************************************************************!*\
  !*** ./src/app/current-tab-page/current-tab-page.component.css ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL2N1cnJlbnQtdGFiLXBhZ2UvY3VycmVudC10YWItcGFnZS5jb21wb25lbnQuY3NzIn0= */");

/***/ }),

/***/ "./src/app/current-tab-page/current-tab-page.component.ts":
/*!****************************************************************!*\
  !*** ./src/app/current-tab-page/current-tab-page.component.ts ***!
  \****************************************************************/
/*! exports provided: CurrentTabPageComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CurrentTabPageComponent", function() { return CurrentTabPageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let CurrentTabPageComponent = class CurrentTabPageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
], CurrentTabPageComponent.prototype, "stateSealImg", void 0);
CurrentTabPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-current-tab-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./current-tab-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/current-tab-page/current-tab-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./current-tab-page.component.css */ "./src/app/current-tab-page/current-tab-page.component.css")).default]
    })
], CurrentTabPageComponent);



/***/ }),

/***/ "./src/app/favorites-page/favorite-places.ts":
/*!***************************************************!*\
  !*** ./src/app/favorites-page/favorite-places.ts ***!
  \***************************************************/
/*! exports provided: FavoritePlaces */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritePlaces", function() { return FavoritePlaces; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class FavoritePlaces {
    constructor(image, city, state, lat, lon) {
        this.image = image;
        this.city = city;
        this.state = state;
        this.lat = lat;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL2Zhdm9yaXRlcy1wYWdlL2Zhdm9yaXRlcy1wYWdlLmNvbXBvbmVudC5jc3MifQ== */");
...
let FavoritesPageComponent = class FavoritesPageComponent {
    constructor(storage, route) {
        ...
        // @ViewChild('favoritesTable')
        this.storedDataEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.favorites$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]([]);
        this.listSubject$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        // displayedColumns: string[] = ['#', 'images', 'city', 'state', 'favorites'];
        this.displayedColumns = ['row', 'icon', 'city', 'state', 'favorites'];
        this.columnsToDisplay = this.displayedColumns.slice();
        // this.favorites$=of(this.storage.getFavorites());
        // this.favorites$.subscribe(data => console.log(data));
        // this.favorites=this.storage.getFavorites();
        route.params.subscribe(params => console.log('favorites-page id parameter', params));
    }
    delete(index) {
        this.storage.removeFavorite(index);
        // return this.storage.getFavorites();
        this.favorites = this.storage.getFavorites();
    }
    useFavorite(index) {
        const selection = this.favorites[index];
        console.log(selection, 'selection');
        this.storedDataEmitter.emit(selection);
    }
    // getData() {
    //   // let count: number=0;
    //   const currentList = this.storage.getFavorites();
    ...
    // }
    showFavorites() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.storage.getFavorites());
    }
    ngOnInit() {
        // this.favorites$ = of(this.storage.getFavorites());
        this.favorites = this.storage.getFavorites();
        //
        // this.showFavorites().subscribe(values => this.favorites$=values);
        // of(this.getData()).subscribe(values => this.data$=values);
        //
        // const newFavorite = new FavoritePlaces('img url', 'los angeles', 'ca', 'lat', 'lon');
        console.log('local storage available?', this.storage.canStore());
        // this.storage.addFavorite(newFavorite);
        // strFavorites=this.storage.getFavorites();
        console.log('this.favorites', this.favorites);
        // this.listSubject$.pipe(
        //   debounceTime(200),
        //   distinctUntilChanged(),
        //   switchMap(val => {this.list = this.favorites; return this.list; }));
        // console.log('listSubject', this.listSubject$);
        // this.listSubject$.subscribe(value => this.list = value);
...
FavoritesPageComponent.ctorParameters = () => [
    { type: _local_storage_service__WEBPACK_IMPORTED_MODULE_4__["LocalStorageService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], FavoritesPageComponent.prototype, "storedDataEmitter", void 0);
FavoritesPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-favorites-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./favorites-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/favorites-page/favorites-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./favorites-page.component.css */ "./src/app/favorites-page/favorites-page.component.css")).default]
    })
...
/***/ "./src/app/hourly-tab-page/hourly-tab-page.component.css":
/*!***************************************************************!*\
  !*** ./src/app/hourly-tab-page/hourly-tab-page.component.css ***!
  \***************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL2hvdXJseS10YWItcGFnZS9ob3VybHktdGFiLXBhZ2UuY29tcG9uZW50LmNzcyJ9 */");

/***/ }),

/***/ "./src/app/hourly-tab-page/hourly-tab-page.component.ts":
/*!**************************************************************!*\
  !*** ./src/app/hourly-tab-page/hourly-tab-page.component.ts ***!
  \**************************************************************/
/*! exports provided: HourlyTabPageComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HourlyTabPageComponent", function() { return HourlyTabPageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let HourlyTabPageComponent = class HourlyTabPageComponent {
    constructor() {
        this.selectOptions = ['temperature', 'pressure', 'humidity', 'ozone', 'visibility', 'windSpeed'];
        this.optionUnits = {
    ...
    // updateSelectedParam(selection:string){
    //   this.selectedParam$.next(selection);
    // }
    // testDate= formatDate(1573484400, 'd/M/yyyy','', '');
    // toDate(time: number) { return formatDate(time, 'd/M/yyyy','', ''); }
    ...
    //   responsive: true,
    // };
    // barChartLabels: Label[] ;//= this.x;// ['Apple', 'Banana', 'Kiwifruit', 'Blueberry', 'Orange', 'Grapes'];
    // barChartType: ChartType = 'bar';
    // barChartLegend = true;
    // barChartPlugins = [];
    //
    // barChartData: ChartDataSets[] = [
    //   {data: this.y, label: this.selectedParamVal}
    // ];
    // getData(selected){
    //   this.hourlyData.forEach((val) =>{
    //     this.x.push(val.index);
    //     this.y.push(val[selected.value]);
    // });
    //   console.log(this.x, this.y);
    // }
    getBarChartData() {
        return { data: this.y, label: this.selectedParamVal };
    }
    getBarChartLabels() {
        return this.x;
    }
    ...
    updateSelectParam(event) {
        console.log(event.target.value);
        this.selectedParam$.next(event.target.value);
        this.selectedParam$.asObservable().subscribe(v => { this.selectedParamVal = v; });
        // console.log(this.selectedParamVal);
        this.hourlyData.forEach((val, i) => {
            this.y[i] = val[this.selectedParamVal];
            this.x[i] = i;
        });
        this.yUnit = this.optionUnits[this.selectedParamVal];
        this.chart.options.scales.yAxes[0].scaleLabel.labelString = this.yUnit;
        this.chart.data.datasets[0].label = this.selectedParamVal;
        // this.chart.options.legend.labels.generateLabels();
        console.log('units: ', this.optionUnits[this.selectedParamVal]);
        console.log(this.x, this.y);
        this.updateChart();
    }
    getParamData() {
        return this.selectedParam$.asObservable();
    }
    ngOnInit() {
        this.selectedParam$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]('temperature');
        this.selectedParamVal$ = this.getParamData();
        // this.selectedParamVal$.subscribe(this.selectedParamVal);
        this.selectedParamVal = 'temperature';
        this.yUnit = this.optionUnits[this.selectedParamVal];
        console.log('this.selectedParamVal$', this.selectedParamVal$);
        this.x = new Array(24);
        this.y = new Array(24);
        //datasets=[{data:, label:},]
        this.hourlyData.forEach((val, i) => {
            console.log(val);
            this.y[i] = val.temperature;
            this.x[i] = i;
            // this.selectOptions.forEach((option, idx) => {
            //   console.log(option, this.val[i]);
            //   this.datasets[option].push(val[i]);
            // });
            // this.y[i] = val[this.selectedParamVal];
            // this.x[i] = i;
        });
        ...
        this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_2__["Chart"](this.chartRef.nativeElement, {
            ...
            data: {
                ...
                datasets: [
                    {
                        data: this.y,
                        backgroundColor: 'rgba(129, 202, 240, 0.8)',
                        borderColor: 'rgba(129, 202, 240, 1)',
                        pointHoverBackgroundColor: 'rgba(12, 20, 24, .5)',
                        label: this.selectedParamVal
                    }
                ]
            },
            options: {
        ...
        // console.log(this.datasets.toString());
    }
    // console.log('getting selection');
    // const temp=this.getParamData();
    // console.log(temp);
    // console.log( moment(1573484400000).format('d-M-YYYY'));
    // this.hourlyData.forEach((val, i) =>{
    //   this.x.push(val.index);
    //   this.y.push(val[this.selected]);
    // });
    // console.log(this.x);
    // console.log(this.y);
    ngOnChanges(changes) {
        console.log(moment__WEBPACK_IMPORTED_MODULE_3__(1573484400000).format('d-M-YYYY'));
        // this.x = new Array(24);
        // this.y = new Array(24);
        //datasets=[{data:, label:},]
    }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], HourlyTabPageComponent.prototype, "hourlyData", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('barChart', { static: true })
], HourlyTabPageComponent.prototype, "chartRef", void 0);
HourlyTabPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-hourly-tab-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./hourly-tab-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/hourly-tab-page/hourly-tab-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./hourly-tab-page.component.css */ "./src/app/hourly-tab-page/hourly-tab-page.component.css")).default]
    })
], HourlyTabPageComponent);



/***/ }),

/***/ "./src/app/ip-location/ip-location.component.ts":
/*!******************************************************!*\
  !*** ./src/app/ip-location/ip-location.component.ts ***!
  \******************************************************/
/*! exports provided: IpLocationComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IpLocationComponent", function() { return IpLocationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
...
let IpLocationComponent = class IpLocationComponent {
    constructor(http) {
        this.http = http;
        this.locOutput = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](true);
    }
    getLoc() {
        const loc = {
            lat: this.lat,
        ...
        return this.locOutput.emit(loc);
    }
    showIP() {
        return this.http.jsonp('http://ip-api.com/json/', 'callback').subscribe((res) => {
...
IpLocationComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], IpLocationComponent.prototype, "locOutput", void 0);
IpLocationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-ip-location',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ip-location.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/ip-location/ip-location.component.html")).default,
    })
], IpLocationComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL2xvYWRlci9sb2FkZXIuY29tcG9uZW50LmNzcyJ9 */");
...
//       this.isLoading = v; //changed from "loading"
//     });
//   }
//   ngOnInit() {
//   }
...
let LocalStorageService = class LocalStorageService {
    ...
    //   const count: number = updatedList.length || 0;
    //   if (count>0) {
    //     for (i = 0; i < count; i++) {
    //
    //     }
    //     }
    //     this.storage.set(STORAGE_KEY, updatedList);
    //     return count;
    //   }
    checkDuplicate(city, state) {
        const currentFavorites = this.storage.get(STORAGE_KEY) || [];
        city = city.toLowerCase();
        state = state.toUpperCase();
        const duplicate = currentFavorites.filter(item => ((item.city === city) && (item.state === state)));
        if (duplicate.length > 0) {
            return true;
        }
        console.log('duplicate list', city, state, duplicate);
        return false;
    }
    addFavorite(favoritedObj) {
        // get array of tasks from local storage
        const currentFavorites = this.storage.get(STORAGE_KEY) || [];
        console.log('current favorites', currentFavorites);
        if (currentFavorites === []) {
            currentFavorites.push(favoritedObj);
            this.storage.set(STORAGE_KEY, currentFavorites);
            return;
        }
        else {
            if (!this.checkDuplicate(favoritedObj.city, favoritedObj.state)) {
                currentFavorites.push(favoritedObj);
                this.storage.set(STORAGE_KEY, currentFavorites);
            }
        }
    ...
    getFavorites() {
        this.favorites = this.storage.get(STORAGE_KEY) || [];
        return this.favorites;
    }
    removeFavorite(i) {
        // const updatedFavorites = this.favorites;
        // updatedFavorites.splice(i, 1);
        // this.storage.set(STORAGE_KEY, updatedFavorites);
        // this.favorites = updatedFavorites;
        console.log('removed favorite ' + i);
        this.favorites.splice(i, 1);
        this.storage.set(STORAGE_KEY, this.favorites);
        return this.getFavorites();
    }
    removeFavoriteByCity(city, state) {
        city = city.toLowerCase();
        state = state.toUpperCase();
        let currentFavorites = this.storage.get(STORAGE_KEY) || [];
        if (currentFavorites.length > 0) {
            // currentFavorites.filter(item => (item.city !== city)) && (item.state !== street);
            currentFavorites = currentFavorites.filter(item => ((item.city !== city) && (item.state !== state)));
            this.storage.set(STORAGE_KEY, currentFavorites);
        }
    }
    clearAllFavorites() {
    ...
    canStore() {
        return Object(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_2__["isStorageAvailable"])(localStorage);
    }
};
...
class Location {
    constructor(street, city, state, auto) {
        // super(props);
        this.street = street;
        this.city = city;
        this.state = state;
...
/* harmony import */ var _favorites_page_favorite_places__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../favorites-page/favorite-places */ "./src/app/favorites-page/favorite-places.ts");


// import {IpLocationService, IpLocation} from '../ip-location/ip-location.service';
...
let ResultsPageComponent = class ResultsPageComponent {
    constructor(http, loader, api, storage, activatedRoute) {
        this.http = http;
        this.loader = loader;
        this.api = api;
        this.storage = storage;
        ...
        // activatedRoute.params.subscribe(params => console.log('results-page id parameter', params['id']));
    ...
    star() {
        this.isStarred = true;
        const newFavorite = new _favorites_page_favorite_places__WEBPACK_IMPORTED_MODULE_7__["FavoritePlaces"](this.stateSealImg, this.locationData.city.toLowerCase(), this.locationData.state, this.locationData.lat, this.locationData.lon);
    ...
    unstar() {
        ...
        this.storage.removeFavoriteByCity(this.locationData.city, this.locationData.state);
    }
    getTweet() {
        let url = 'https://twitter.com/intent/tweet?text=The%20current%20temperature%20at%20';
        const text = this.locationData.city + ' is ' + this.weatherData.currently.temperature + '°F. The weather condidtions are ' + this.weatherData.currently.summary + '.';
        console.log('tweet', text, encodeURI(text));
        url += encodeURI(text) + '&hashtags=CSCI571WeatherSearch';
        return url;
    }
    createHttpOptions(letters) {
        //
        // e.g., http://website.com/query?q=dom'
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]({ fromObject: { address: letters } });
        const headerMap = { 'x-refresh': 'false' };
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](headerMap);
        return { headers, params };
    }
    // getLocationFromIP() {
    //   return this.http.jsonp('http://ip-api.com/json/', 'callback').subscribe((res: any) => {
    //     this.state = res.region;
    //     this.city = res.city;
    //     this.lat = res.lat;
    //     this.lon = res.lon;
    ...
    getWeatherData() {
        if (this.lat && this.lon) {
            return this.api.getWeather(this.lat, this.lon).subscribe(data => {
    ...
    showStateSeal() {
        return this.api.getStateSeal(this.locationData.state).subscribe((res) => {
            this.stateSealImg = res;
            console.log('retreived image', this.stateSealImg);
            // this.loader.isLoading.next(false);
        });
    }
    // private fetchData(){
    //   const promise = this.http.get(this.locationData.lat, this.locationData.lon).toPromise();
    //   console.log(promise);
    //   promise.then((data)=>{
    ...
    fetchData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.weatherData = yield this.api.getWeather(this.locationData.lat, this.locationData.lon).toPromise();
            this.stateSealImg = yield this.api.getStateSeal(this.locationData.state).toPromise();
        });
    }
    ngOnInit() {
        ...
        console.log('results-page ngOnInit');
        // this.selectedParam$= new BehaviorSubject<string>('temperature');
        // this.selectedParam$.subscribe(console.log);
        // this.api.getWeather(this.lat, this.lon).subscribe(results =>{ this.weatherData= results;} );
        //
        // this.api.getStateSeal(this.locationData.state).subscribe(results =>{ this.stateSealImg = results;} );
        //
        // console.log(this.weatherData);
        // console.log(this.stateSealImg);
        // await this.api.getStateSeal(this.locationData.state).subscribe((data:string) => {
        //   this.stateSealImg=data;
        //   console.log(this.stateSealImg);
        // }
        // );
        ...
        //     this.log(v);
        //   });
        // this.api.getWeather(this.locationData.lat,this.locationData.lon)
        //   .merge(
        // this.getWeatherData();
        // this.showStateSeal();
    }
    ...
    ngOnChanges(changes) {
        ...
        let change = changes.storedData;
        console.log(change, 'change');
        if (change.currentValue != null) {
            this.locationData = change.currentValue;
        }
        console.log('change.currentValue', change.currentValue);
    }
    ngAfterViewInit() {
        console.log('results-page ngAfterViewInit');
        // if (this.locationData.lat && this.locationData.lon) {
        this.api.getWeather(this.locationData.lat, this.locationData.lon).subscribe(results => {
        ...
        // }
        this.api.getStateSeal(this.locationData.state).subscribe((data) => {
            this.stateSealImg = data;
            console.log('state seal', this.stateSealImg);
        });
        this.isStarred = this.storage.checkDuplicate(this.locationData.city, this.locationData.state);
        console.log('this.isStarred', this.isStarred);
        // this.fetchData()
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsPageComponent.prototype, "locationData", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsPageComponent.prototype, "weatherData", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsPageComponent.prototype, "loadingVal", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsPageComponent.prototype, "stateSealImg", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsPageComponent.prototype, "storedData", void 0);
ResultsPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-results-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./results-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/results-page/results-page.component.html")).default
...
/***/ "./src/app/tabset-config/tabset-config.component.css":
/*!***********************************************************!*\
  !*** ./src/app/tabset-config/tabset-config.component.css ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL3RhYnNldC1jb25maWcvdGFic2V0LWNvbmZpZy5jb21wb25lbnQuY3NzIn0= */");

/***/ }),

/***/ "./src/app/tabset-config/tabset-config.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/tabset-config/tabset-config.component.ts ***!
  \**********************************************************/
/*! exports provided: TabsetConfigComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabsetConfigComponent", function() { return TabsetConfigComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let TabsetConfigComponent = class TabsetConfigComponent {
    constructor() { }
    ngOnInit() {
    }
};
TabsetConfigComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  `,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./tabset-config.component.css */ "./src/app/tabset-config/tabset-config.component.css")).default]
    })
...
/***/ "./src/app/weather-search/weather-search.component.css":
/*!*************************************************************!*\
  !*** ./src/app/weather-search/weather-search.component.css ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL3dlYXRoZXItc2VhcmNoL3dlYXRoZXItc2VhcmNoLmNvbXBvbmVudC5jc3MifQ== */");
...
/* harmony import */ var _location__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../location */ "./src/app/location.ts");
/* harmony import */ var _autocomplete_autocomplete_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../autocomplete/autocomplete.service */ "./src/app/autocomplete/autocomplete.service.ts");
...
let WeatherSearchComponent = class WeatherSearchComponent {
    constructor(http, autocompleteService, formBuilder, api, loader) {
        this.http = http;
        ...
        this.loader = loader;
        //
        this.displayResults = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.displayError = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.isInvalid = false;
        this.isLoading = false;
        // weatherData;
        // stateSealImg;
        this.searchText$ = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
        ...
        this.model = new _location__WEBPACK_IMPORTED_MODULE_4__["Location"]('', '', '', false);
        this.submitted = false;
        this.model = this.modelDefault();
    }
    modelDefault() {
        // default value for the object 'user'
        return {
            state: '',
            city: '',
            street: '',
    ...
    onSubmit(form, submitBtnName) {
        console.log('SUBMITTED', form, form.target[1].value, form.target.inputStreet.value);
        console.log('values:', form.target.inputStreet.value, form.target.inputCity.value, form.target.inputState.value, form.target.inputAuto.value);
        console.log('model', form.target.model);
        console.log('submitBtnName', submitBtnName);
    }
    checkForm(form, btnName) {
        console.log('checking form...', form, form.target);
        // this.loader.isLoading.next(true);
        if (btnName === 'submitAuto') {
            this.api.autoLocate().subscribe((res) => {
                this.validForm = {
                    method: 'auto',
                    lat: res.lat,
                    lon: res.lon,
                ...
                console.log([btnName, this.validForm.lat]);
                // this.submitted = true;
                // this.displayResults.emit(this.submitted);
            }, error => {
                this.isInvalid = true;
                this.showErrors = true;
                this.displayError.emit(this.isInvalid);
            });
        }
        else {
            this.validForm = {
                ...
                lat: '',
                lon: '',
                street: form.hiddenStreet.value,
                city: form.hiddenCity.value,
                state: form.inputState.value
            };
            console.log([btnName], this.validForm.toString());
            this.api.getLatLon(this.validForm.street, this.validForm.city, this.validForm.state).subscribe((response) => {
                const coords = response;
                if (coords.errorMsg) {
                    this.errorMsg = coords.errorMsg;
                    console.log("coords.errorMsg", coords.errorMsg);
                    this.isInvalid = true;
                    this.showErrors = true;
                    this.displayError.emit(this.isInvalid);
                }
                else {
                    this.validForm.lat = coords.lat;
                    this.validForm.lon = coords.lon;
                    this.isInvalid = false;
                    this.showErrors = false;
                    // this.submitted = true;
                }
        ...
        this.submitted = true;
        this.displayResults.emit(this.submitted);
        // if ((btnName !== 'submitAuto') && (this.validForm.lat=='' || this.validForm.lon =='')){
        //   this.showErrors=true;
        //   this.isInvalid=true;
        // }
        console.log('this.validForm', this.validForm);
        console.log('form submitted?', this.submitted);
        console.log('form invalid?', this.isInvalid);
        console.log('form showError?', this.showErrors);
        // this.displayResults.emit(this.submitted);
    ...
    createHttpOptions(letters) {
        //
        // e.g., http://website.com/query?q=dom'
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]({ fromObject: { address: letters } });
        const headerMap = { 'x-refresh': 'true' };
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"](headerMap);
        return { headers, params };
    }
    resetSearchForm() {
        console.log('form clearing');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'x-refresh': 'true' });
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]();
        location.reload();
        // return this.http.get('search', {headers, params});
    }
    toggleFields(event) {
        console.log(event.target.value, event.target.checked);
        console.log(event.target);
        // this.model = new Location('', '', '', event.target.checked);
        this.model.auto = event.target.checked;
        console.log(this.model.auto);
    }
    suggestCities(letters) {
        this.searchText$.next(letters);
        console.log('call suggestCities');
        console.log(this.suggestions$);
    }
    chooseState(event) {
        const selectedValue = event.target.value;
        this.model.state = selectedValue;
        this.inputtedState = selectedValue;
        console.log(this.inputtedState, this.model.state);
    }
    ngOnInit() {
        this.model = this.modelDefault();
        this.http.get('./assets/States.txt').subscribe((data) => {
            this.arrStates = data.States;
        }, (err) => {
            console.log(err.message);
        });
        this.suggestions$ = this.searchText$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(() => this.isLoading = true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])((letters) => {
            if (letters === '') {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])([]);
            }
            else {
                return this.autocompleteService.suggestCity(letters)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["finalize"])(() => this.isLoading = false));
            }
        }));
    }
};
WeatherSearchComponent.ctorParameters = () => [
    ...
    { type: _autocomplete_autocomplete_service__WEBPACK_IMPORTED_MODULE_5__["AutocompleteService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _api_service__WEBPACK_IMPORTED_MODULE_8__["ApiService"] },
    { type: _ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_9__["LoadingBarService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], WeatherSearchComponent.prototype, "errorMsg", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], WeatherSearchComponent.prototype, "displayResults", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], WeatherSearchComponent.prototype, "displayError", void 0);
WeatherSearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-weather-search',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./weather-search.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/weather-search/weather-search.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./weather-search.component.css */ "./src/app/weather-search/weather-search.component.css")).default]
    })
...
/***/ "./src/app/weekly-tab-page/modal-options.module.ts":
/*!*********************************************************!*\
  !*** ./src/app/weekly-tab-page/modal-options.module.ts ***!
  \*********************************************************/
/*! exports provided: NgbdModalOptionsModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgbdModalOptionsModule", function() { return NgbdModalOptionsModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
/* harmony import */ var _modal_options__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modal-options */ "./src/app/weekly-tab-page/modal-options.ts");





let NgbdModalOptionsModule = class NgbdModalOptionsModule {
};
NgbdModalOptionsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_modal_options__WEBPACK_IMPORTED_MODULE_4__["NgbdModalOptions"]],
        exports: [_modal_options__WEBPACK_IMPORTED_MODULE_4__["NgbdModalOptions"]],
        bootstrap: [_modal_options__WEBPACK_IMPORTED_MODULE_4__["NgbdModalOptions"]]
    })
...
/***/ "./src/app/weekly-tab-page/modal-options.ts":
/*!**************************************************!*\
  !*** ./src/app/weekly-tab-page/modal-options.ts ***!
  \**************************************************/
...
let NgbdModalOptions = class NgbdModalOptions {
...
NgbdModalOptions.ctorParameters = () => [
...
NgbdModalOptions = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./modal-options.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/weekly-tab-page/modal-options.html")).default,
...
/***/ "./src/app/weekly-tab-page/weekly-tab-page.component.ts":
/*!**************************************************************!*\
  !*** ./src/app/weekly-tab-page/weekly-tab-page.component.ts ***!
  \**************************************************************/
/*! exports provided: WeeklyTabPageComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WeeklyTabPageComponent", function() { return WeeklyTabPageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/assets/canvasjs.min.js */ "./src/assets/canvasjs.min.js");
/* harmony import */ var src_assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(src_assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_2__);
...
let WeeklyTabPageComponent = class WeeklyTabPageComponent {
    constructor(// constructor(private modalService: BsModalService) {
    ...
    api) {
        ...
        this.makeRequest$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
        //{'time':1574269200,'temperature':15.82,'summary':'Overcast','icon':'cloudy','precipitation':0.0014,'chanceOfRain':0.03,'humidity':0.68,'pressure':1024,'windspeed':6.08,'visibility':10}
        this.content = {
            city: '',
            temperature: '',
            time: '',
    ...
    // }
    showModal() {
        this.modalService.open(this.weeklyModal);
    }
    openWindowCustomClass(content) {
        this.modalService.open(content, { windowClass: 'dark-modal' });
    }
    ...
    // onClick(event) {
    //   // const link = event.dataPoint.link;
    //   console.log(event);
    //   console.log(this.content);
    //   this.openWindowCustomClass(this.content);
    // }
    getData(day) {
        this.makeRequest$.next(day);
    }
    callAPI() {
        return this.api.getWeatherDetails(this.lat, this.lon, this.day);
    }
    ngOnInit() {
        this.dayData$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"]();
        ...
        console.log('weekly-tab-page: ngOnInit()');
        // console.log(this.weeklyData);
        this.weeklyData.forEach((day, i) => {
            const t = day.time; // * 1000;
            const datapoint = { x: i, y: [day.tempLow, day.tempHigh], label: Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(t * 1000, 'M/d/yyyy', 'en-US'), time: t };
            console.log(datapoint);
            this.data[i] = datapoint;
            // return this.data.push(datapoint);
        });
        console.log(this.data);
        const chart = new src_assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_2__["Chart"]('chartContainer', {
            ...
            data: [{
                    type: 'rangeBar',
                    color: 'rgba(129, 202, 240, 0.99)',
                    showInLegend: true,
                    click: (e) => {
                        this.day = this.weeklyData[e.dataPoint.x].time;
                        // this.passEntry.emit(this.weeklyData[e.dataPoint.x].time),
                        // this.dayData$=this.api.getWeatherDetails(this.lat, this.lon, this.day);
                        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["concat"])(this.api.getWeatherDetails(this.lat, this.lon, this.day))
                            .subscribe((values) => {
                            this.dayData = values;
                            console.log('this.dayData', this.dayData);
                            this.content = this.dayData;
                            console.log(this.content, this.content);
                            // this.dayData.valueChanges.pipe(...);
                            // console.log('this.dayData$',this.dayData$);
                            // console.log(this.dayData);
                        });
                        this.openModal(this.weeklyModal);
                    },
                    yValueFormatString: '#',
    ...
    ngAfterViewInit() {
        // function getDetails() {
        //       this.api.getWeatherDetails(this.lat, this.lon, this.day).subscribe((resp: any) => this.dayData$ = resp.data);
        //     }
    }
};
WeeklyTabPageComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"] },
    { type: _api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], WeeklyTabPageComponent.prototype, "weeklyData", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], WeeklyTabPageComponent.prototype, "passEntry", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('weeklyModal', { static: false })
], WeeklyTabPageComponent.prototype, "weeklyModal", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], WeeklyTabPageComponent.prototype, "locationData", void 0);
WeeklyTabPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-weekly-tab-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./weekly-tab-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/weekly-tab-page/weekly-tab-page.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
...
module.exports = __webpack_require__(/*! /Users/kaixiwang/Documents/USC_FA2019/CSCI-571/Homework/HW8/basic4cast_app/basic4cast-angular-client/src/main.ts */"./src/main.ts");
